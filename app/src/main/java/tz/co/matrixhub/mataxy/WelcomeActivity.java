...
import tz.co.matrixhub.mataxy.Common.Common;
...
public class WelcomeActivity extends FragmentActivity implements OnMapReadyCallback,
        ...
        public void run() {
            ...
            animation.addUpdateListener(new android.animation.ValueAnimator.AnimatorUpdateListener() {
                ...
                public void onAnimationUpdate(android.animation.ValueAnimator animation) {
                    ...
                    lat = v*endPosition.latitude+(1-v)*startPosition.longitude;
    ...
    private void getDirection() {
        ...
        try {
            ...
            Log.d("MaTaxy", requestApi); //prints the debug URL
                    ...
                    .enqueue(new Callback<String>() {
                        ...
                        public void onResponse(Call<String> call, Response<String> response) {
                            try {
                                ...
                                //Animation
                                android.animation.ValueAnimator polyLineAnimator = android.animation.ValueAnimator.ofInt(0,100);
                                polyLineAnimator.setDuration(2000);
                                polyLineAnimator.setInterpolator(new LinearInterpolator());
                                polyLineAnimator.addUpdateListener(new android.animation.ValueAnimator.AnimatorUpdateListener() {
                                    @Override
                                    public void onAnimationUpdate(android.animation.ValueAnimator animation) {
